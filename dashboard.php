    ...
    <style>
        * {
        ...
        body {
            ...
            padding: 25px;
            background: url('bintang.jpg') no-repeat;
        ...
        .task-header {
            ...
            align-items: center;
            border-bottom: 2px solid #AEA391;
            padding-bottom: 8px; /* Tambahkan padding bawah */
        ...
        .pencarian-tugas {
            margin-bottom: 18px; /* Tambahkan jarak bawah */
        }
        ...
        .task-list {
            ...
            background-color:#fff; /* Warna latar belakang untuk membedakan */
